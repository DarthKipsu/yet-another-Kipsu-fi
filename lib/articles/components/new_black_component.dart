...
@Component(
    selector: 'new-black',
    templateUrl: 'new_black_component.html',
    directives: const [ArticleMetadataComponent])
class NewBlackComponent implements OnInit {
  ...
  NewBlackComponent(this._titleService, this._routeParams, this._articleService);
